    ...
    try {
        ...
        if (isset($_FILES['file']) && $_FILES['file']['error'] === UPLOAD_ERR_OK) {
            ...
            if (!in_array($file_extension, $allowed_extensions)) {
                throw new Exception("Hata: Eklentiler için sadece .js dosyaları yüklenebilir.");
            }
                ...
                <section class="section">
                    <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="title" name="title" required placeholder="Hava Durumu Eklentisi">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="description" name="description" rows="4" required placeholder="Anlık hava durumunu navbar üzerinde gösterir."></textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="file">Eklenti Dosyası (.js)</label>
                                            <input type="file" class="form-control" id="file" name="file" accept=".js" required>
                                            <small class="text-muted">Sadece JavaScript dosyaları kabul edilir.</small>
                                        </div>

                                        <div class="form-group">
                                            <label for="image">Eklenti İkonu / Resmi</label>
                                            <input type="file" class="form-control" id="image" name="image" accept="image/*">
                                        </div>

                                        <div class="mt-4 d-flex justify-content-end">
                                            <button type="submit" class="btn btn-primary me-1 mb-1">Eklentiyi Yayınla</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"><i class="bi bi-info-circle"></i> Artstelve Eklenti Rehberi</h4>
                                </div>
                                <div class="card-body">
                                    <h6>1. Tek Dosya (.js)</h6>
                                    <p class="text-sm">Basit widgetlar için doğrudan `.js` dosyası yükleyebilirsiniz.</p>
                                    
                                    <h6>2. Paket Halinde (.zip)</h6>
                                    <p class="text-sm">Eğer eklentiniz birden fazla script, stil veya asset içeriyorsa `.zip` formatında yükleyin.</p>
                                    
                                    <h6>3. Programlama Arayüzü</h6>
                                    <p class="text-sm">Eklentiniz Artstelve'nin `window` objesi üzerinden sunduğu API'leri kullanabilir.</p>
                                    
                                    <div class="alert alert-light-warning">
                                        <p class="mb-0 text-sm"><strong>Güvenlik Sorumluluğu:</strong> Yüklediğiniz dosyaların zararlı kod içermediğinden emin olun. Tüm eklentiler topluluk denetimine tabidir.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
